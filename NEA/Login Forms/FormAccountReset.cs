...
namespace NEA
{
    public partial class FormAccountReset : Form
    {
        ...
        private void ResetPassword(string Username, string Phone, string NewPassword)
        {
            ...
            if (_passwordValid)
            {
                ...
                try
                {
                    ...
                    if (userExists > 0)
                    {
                        string hashedInput = new Hashing().GenerateHash(NewPassword, Username);
        ...
        private void ResetButton_Click(object Sender, EventArgs E)
        {
            ...
            {
                ResetPassword(TextBoxUsername.Text, TextBoxPhoneNumber.Text, TextBoxPassword.Text);
            }
